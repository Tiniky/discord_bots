...
def handle_response(msg, username) -> str:
    p_message = msg.lower()
    users = []
    ...
    if message_split[0] == "decide" or message_split[0] == "d":
    ...
    if p_message == "?roll":
        ...
        return "Use 'decide x or y or ...' or 'd x or y or ...' or 'decide saved_decision' and I'm gonna pick one of your given options. If you added a frequent decision you can also use 'decide decision_name'."
